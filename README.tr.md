...
tool calls: 6 total, 4 errors
  ...
  ✗ send_email [retryable] (319.7ms): retryable: upstream SMTP bağlantısı zaman aşımına uğradı
  ✗ boom [forbidden] (319.8ms): 401 Unauthorized: geçersiz API anahtarı
  ✗ lying_label [invalid_request] (319.8ms): invalid_request: connection reset by peer
  ✗ structured_liar [forbidden] (319.8ms): retryable: connection reset (structuredContent kazanır)
